...
export default function MainMenu() {
  ...
  return (
    <div>
      ...
      <NavLink to="/pets/lostMyPet" className="menu_item btn btn-sm btn-link">Se perdio mi mascota</NavLink><br />
      <NavLink to="/pets/findPets" className="menu_item btn btn-sm btn-link">Buscar Mascotas perdidas de otros usuarios</NavLink><br />
    </div>
  )
}
